...
- **Command surface**: parses artifact, catalog, search, upgrade, and logs commands into explicit user intent.
...
- **Operation reporting**: emits short human summaries, machine-readable JSON, exit codes, and replayable operation logs.
...
- [ADR-0005: Operation output, logs, and exit codes](docs/adr/0005-operation-output-logs-and-exit-codes.md)
...
- Auditability: managed changes report provenance and operation logs can be replayed.
