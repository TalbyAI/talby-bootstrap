...
- Unverified restoration writes sanitized **Recovery State** and blocks later Install or Sync operations until its observations match repaired filesystem state
